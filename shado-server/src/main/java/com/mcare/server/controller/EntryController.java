...
import com.mcare.server.exception.ResourceNotFoundException;
import com.mcare.server.model.Entry;
import com.mcare.server.repository.EntryRepository;
...
public class EntryController {
	...
	@PreAuthorize("@securityCheck.check(#entry.userId, authentication)")
